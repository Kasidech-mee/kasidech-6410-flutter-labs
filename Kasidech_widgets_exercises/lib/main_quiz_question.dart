...
import 'package:kasidech_widgets_exercises/components/question_with_choices.dart';
...
class MainQuizQuestion extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: QuestionWithChoices(title: "Where is this this place?", imagePath: "assets/images/kku.jpg", choices: [
